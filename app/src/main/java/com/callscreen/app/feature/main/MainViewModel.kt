...
import com.callscreen.app.interactor.DeleteConversations
import com.callscreen.app.interactor.MarkAllSeen
import com.callscreen.app.interactor.MarkArchived
import com.callscreen.app.interactor.MarkPinned
import com.callscreen.app.interactor.MarkRead
import com.callscreen.app.interactor.MarkUnarchived
import com.callscreen.app.interactor.MarkUnpinned
import com.callscreen.app.interactor.MarkUnread
import com.callscreen.app.interactor.MigratePreferences
import com.callscreen.app.interactor.SpeakThreads
import com.callscreen.app.interactor.SyncContacts
import com.callscreen.app.interactor.SyncMessages
...
import com.callscreen.app.model.EmojiSyncNeeded
import com.callscreen.app.model.SyncLog
        ...
        view.navigationIntent
                .withLatestFrom(state) { drawerItem, state ->
                    ...
                    when (drawerItem) {
                        ...
                        NavItem.SCREENING -> navigator.showScreening()
                        NavItem.DEBUG_LOG -> navigator.showDebug()
