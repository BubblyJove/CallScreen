 ...
 */
package com.callscreen.app.feature.gallery
...
import com.callscreen.app.databinding.GalleryImagePageBinding
import com.callscreen.app.databinding.GalleryVideoPageBinding
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        when (getItemViewType(position)) {
            ...
            VIEW_TYPE_VIDEO -> {
                ...
                val dataSourceFactory = DefaultDataSourceFactory(context, "CallScreen")
